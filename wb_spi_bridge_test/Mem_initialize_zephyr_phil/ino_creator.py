...
hex_filename = "../../fram_connect_debug/src/servant_1.3.0/sw/zephyr_phil.hex"  # your .hex file
output_filename = "Mem_initialize_zephyr_phil.txt"  # the .txt you want to create
